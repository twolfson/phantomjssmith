...
// Define our format to extension mapping
var formatToExtMap = {
  png: 'png',
  'image/png': 'png',
  jpg: 'jpeg',
...
function exportCanvas(options, callback) {
  // Find our matching extension for the given format
  var format = options.format || 'png';
  var ext = formatToExtMap[format];
  assert(ext, '`phantomjssmith` doesn\'t support exporting "' + format + '". Please use "jpeg" or "png"');
